...
/** Arguments for filtering the RootQueryToDrinkConnection connection */
export interface RootQueryToDrinkConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: Maybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: Maybe<Scalars['Boolean']>;
...
/** Arguments for filtering the RootQueryToMealConnection connection */
export interface RootQueryToMealConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: Maybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: Maybe<Scalars['Boolean']>;
...
/** Arguments for filtering the RootQueryToSideConnection connection */
export interface RootQueryToSideConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: Maybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: Maybe<Scalars['Boolean']>;
...
/** Input for the createDrink mutation */
...
/** Input for the createMeal mutation */
...
/** Input for the createSide mutation */
...
/** Input for the deleteDrink mutation */
export interface DeleteDrinkInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars['Boolean']>;
  /** The ID of the drink to delete */
  id: Scalars['ID'];
}

/** Input for the deleteMeal mutation */
...
/** Input for the deleteSide mutation */
export interface DeleteSideInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars['Boolean']>;
...
/** Input for the updateDrink mutation */
export interface UpdateDrinkInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: Maybe<Scalars['String']>;
  /** The ID of the drink object */
  id: Scalars['ID'];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars['Int']>;
  /** The password used to protect the content of the object */
...
/** Input for the updateMeal mutation */
export interface UpdateMealInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: Maybe<Scalars['String']>;
  /** The ID of the meal object */
  id: Scalars['ID'];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars['Int']>;
  /** The password used to protect the content of the object */
...
/** Input for the updateSide mutation */
export interface UpdateSideInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: Maybe<Scalars['String']>;
  /** The ID of the side object */
  id: Scalars['ID'];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars['Int']>;
  /** The password used to protect the content of the object */
...
export const generatedSchema = {
  query: {
    ...
    drink: {
      __type: 'Drink',
      __args: { id: 'ID!', idType: 'DrinkIdType', asPreview: 'Boolean' },
    },
    drinkBy: {
      __type: 'Drink',
      __args: { id: 'ID', drinkId: 'Int', uri: 'String', slug: 'String' },
    },
    drinks: {
      __type: 'RootQueryToDrinkConnection',
      __args: {
        first: 'Int',
        last: 'Int',
        after: 'String',
        before: 'String',
        where: 'RootQueryToDrinkConnectionWhereArgs',
      },
    },
    generalSettings: { __type: 'GeneralSettings' },
    meal: {
      __type: 'Meal',
      __args: { id: 'ID!', idType: 'MealIdType', asPreview: 'Boolean' },
    },
    mealBy: {
      __type: 'Meal',
      __args: { id: 'ID', mealId: 'Int', uri: 'String', slug: 'String' },
    },
    meals: {
      __type: 'RootQueryToMealConnection',
      __args: {
        first: 'Int',
        last: 'Int',
        after: 'String',
        before: 'String',
        where: 'RootQueryToMealConnectionWhereArgs',
      },
    },
    mediaItem: {
      __type: 'MediaItem',
    ...
    side: {
      __type: 'Side',
      __args: { id: 'ID!', idType: 'SideIdType', asPreview: 'Boolean' },
    },
    sideBy: {
      __type: 'Side',
      __args: { id: 'ID', sideId: 'Int', uri: 'String', slug: 'String' },
    },
    sides: {
      __type: 'RootQueryToSideConnection',
      __args: {
        first: 'Int',
        last: 'Int',
        after: 'String',
        before: 'String',
        where: 'RootQueryToSideConnectionWhereArgs',
      },
    },
  ...
  mutation: {
    ...
    createDrink: {
      __type: 'CreateDrinkPayload',
      __args: { input: 'CreateDrinkInput!' },
    },
    createMeal: {
      __type: 'CreateMealPayload',
      __args: { input: 'CreateMealInput!' },
    },
    createMediaItem: {
    ...
    createSide: {
      __type: 'CreateSidePayload',
      __args: { input: 'CreateSideInput!' },
    },
    createTag: {
    ...
    deleteDrink: {
      __type: 'DeleteDrinkPayload',
      __args: { input: 'DeleteDrinkInput!' },
    },
    deleteMeal: {
      __type: 'DeleteMealPayload',
      __args: { input: 'DeleteMealInput!' },
    },
    deleteMediaItem: {
    ...
    deleteSide: {
      __type: 'DeleteSidePayload',
      __args: { input: 'DeleteSideInput!' },
    },
    deleteTag: {
    ...
    updateDrink: {
      __type: 'UpdateDrinkPayload',
      __args: { input: 'UpdateDrinkInput!' },
    },
    updateMeal: {
      __type: 'UpdateMealPayload',
      __args: { input: 'UpdateMealInput!' },
    },
    updateMediaItem: {
    ...
    updateSide: {
      __type: 'UpdateSidePayload',
      __args: { input: 'UpdateSideInput!' },
    },
    updateTag: {
  ...
  Drink: {
    ...
    isPreview: { __type: 'Boolean' },
    isRestricted: { __type: 'Boolean' },
    largePrice: { __type: 'String' },
    lastEditedBy: { __type: 'ContentNodeToEditLastConnectionEdge' },
    link: { __type: 'String' },
    modified: { __type: 'String' },
    modifiedGmt: { __type: 'String' },
    preview: { __type: 'DrinkToPreviewConnectionEdge' },
    previewRevisionDatabaseId: { __type: 'Int' },
    previewRevisionId: { __type: 'ID' },
    slug: { __type: 'String' },
    smallPrice: { __type: 'String' },
    status: { __type: 'String' },
    template: { __type: 'ContentTemplate' },
    templates: { __type: '[String]' },
    title: { __type: 'String' },
  ...
  DrinkToPreviewConnectionEdge: {
    __typename: { __type: 'String!' },
    node: { __type: 'Drink' },
  },
  RootQueryToDrinkConnectionWhereArgs: {
    dateQuery: { __type: 'DateQueryInput' },
    hasPassword: { __type: 'Boolean' },
    id: { __type: 'Int' },
    in: { __type: '[ID]' },
  ...
  RootQueryToDrinkConnection: {
    __typename: { __type: 'String!' },
    edges: { __type: '[RootQueryToDrinkConnectionEdge]' },
    nodes: { __type: '[Drink]' },
    pageInfo: { __type: 'WPPageInfo' },
  },
  RootQueryToDrinkConnectionEdge: {
    __typename: { __type: 'String!' },
    cursor: { __type: 'String' },
    node: { __type: 'Drink' },
  },
  ...
  Meal: {
    __typename: { __type: 'String!' },
    calories: { __type: 'Float' },
    comboCost: { __type: 'String' },
    conditionalTags: { __type: 'ConditionalTags' },
    contentType: { __type: 'ContentNodeToContentTypeConnectionEdge' },
    cost: { __type: 'String' },
    databaseId: { __type: 'Int!' },
    ...
    modified: { __type: 'String' },
    modifiedGmt: { __type: 'String' },
    preview: { __type: 'MealToPreviewConnectionEdge' },
    previewRevisionDatabaseId: { __type: 'Int' },
    previewRevisionId: { __type: 'ID' },
    slug: { __type: 'String' },
    status: { __type: 'String' },
  ...
  MealToPreviewConnectionEdge: {
    __typename: { __type: 'String!' },
    node: { __type: 'Meal' },
  },
  RootQueryToMealConnectionWhereArgs: {
    dateQuery: { __type: 'DateQueryInput' },
    hasPassword: { __type: 'Boolean' },
    id: { __type: 'Int' },
    in: { __type: '[ID]' },
  ...
  RootQueryToMealConnection: {
    __typename: { __type: 'String!' },
    edges: { __type: '[RootQueryToMealConnectionEdge]' },
    nodes: { __type: '[Meal]' },
    pageInfo: { __type: 'WPPageInfo' },
  },
  RootQueryToMealConnectionEdge: {
    __typename: { __type: 'String!' },
    cursor: { __type: 'String' },
    node: { __type: 'Meal' },
  },
  ...
  Side: {
    ...
    modified: { __type: 'String' },
    modifiedGmt: { __type: 'String' },
    preview: { __type: 'SideToPreviewConnectionEdge' },
    previewRevisionDatabaseId: { __type: 'Int' },
    previewRevisionId: { __type: 'ID' },
    sideId: { __type: 'Int!' },
    slug: { __type: 'String' },
  ...
  SideToPreviewConnectionEdge: {
    __typename: { __type: 'String!' },
    node: { __type: 'Side' },
  },
  RootQueryToSideConnectionWhereArgs: {
    dateQuery: { __type: 'DateQueryInput' },
    hasPassword: { __type: 'Boolean' },
    id: { __type: 'Int' },
    in: { __type: '[ID]' },
  ...
  RootQueryToSideConnection: {
    __typename: { __type: 'String!' },
    edges: { __type: '[RootQueryToSideConnectionEdge]' },
    nodes: { __type: '[Side]' },
    pageInfo: { __type: 'WPPageInfo' },
  },
  RootQueryToSideConnectionEdge: {
    __typename: { __type: 'String!' },
    cursor: { __type: 'String' },
    node: { __type: 'Side' },
  },
  ...
  [SchemaUnionsKey]: {
    ...
    PostObjectUnion: ['Post', 'Page', 'MediaItem', 'Meal', 'Side', 'Drink'],
...
export interface Query {
  ...
  drink: (args: {
    id: Scalars['ID'];
    idType?: Maybe<DrinkIdType>;
    asPreview?: Maybe<Scalars['Boolean']>;
  }) => Maybe<Drink>;
  drinkBy: (args?: {
    id?: Maybe<Scalars['ID']>;
    drinkId?: Maybe<Scalars['Int']>;
  ...
  drinks: (args?: {
    ...
    after?: Maybe<Scalars['String']>;
    before?: Maybe<Scalars['String']>;
    where?: Maybe<RootQueryToDrinkConnectionWhereArgs>;
  }) => Maybe<RootQueryToDrinkConnection>;
  generalSettings?: Maybe<GeneralSettings>;
  meal: (args: {
    id: Scalars['ID'];
    idType?: Maybe<MealIdType>;
    asPreview?: Maybe<Scalars['Boolean']>;
  }) => Maybe<Meal>;
  mealBy: (args?: {
    id?: Maybe<Scalars['ID']>;
  ...
  meals: (args?: {
    ...
    after?: Maybe<Scalars['String']>;
    before?: Maybe<Scalars['String']>;
    where?: Maybe<RootQueryToMealConnectionWhereArgs>;
  }) => Maybe<RootQueryToMealConnection>;
  mediaItem: (args: {
    id: Scalars['ID'];
  ...
  sides: (args?: {
    ...
    after?: Maybe<Scalars['String']>;
    before?: Maybe<Scalars['String']>;
    where?: Maybe<RootQueryToSideConnectionWhereArgs>;
  }) => Maybe<RootQueryToSideConnection>;
...
export interface Mutation {
  ...
  createDrink: (args: { input: CreateDrinkInput }) => Maybe<CreateDrinkPayload>;
  createMeal: (args: { input: CreateMealInput }) => Maybe<CreateMealPayload>;
  ...
  createSide: (args: { input: CreateSideInput }) => Maybe<CreateSidePayload>;
  ...
  deleteDrink: (args: { input: DeleteDrinkInput }) => Maybe<DeleteDrinkPayload>;
  deleteMeal: (args: { input: DeleteMealInput }) => Maybe<DeleteMealPayload>;
  ...
  deleteSide: (args: { input: DeleteSideInput }) => Maybe<DeleteSidePayload>;
  ...
  updateDrink: (args: { input: UpdateDrinkInput }) => Maybe<UpdateDrinkPayload>;
  updateMeal: (args: { input: UpdateMealInput }) => Maybe<UpdateMealPayload>;
  ...
  updateSide: (args: { input: UpdateSideInput }) => Maybe<UpdateSidePayload>;
...
export interface Drink
  extends Omit<Node, '__typename'>,
    ...
    Omit<DatabaseIdentifier, '__typename'>,
    Omit<NodeWithTemplate, '__typename'> {
  __typename: 'Drink' | undefined;
  calories?: Maybe<ScalarsEnums['String']>;
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the ContentNode type and the ContentType type
   */
  ...
  guid?: Maybe<ScalarsEnums['String']>;
  /**
   * The globally unique identifier of the drink object.
   */
  id: ScalarsEnums['ID'];
  /**
   * Whether the object is a node in the preview state
   ...
   */
  isRestricted?: Maybe<ScalarsEnums['Boolean']>;
  largePrice?: Maybe<ScalarsEnums['String']>;
  /**
   * The user that most recently edited the node
   */
  lastEditedBy?: Maybe<ContentNodeToEditLastConnectionEdge>;
  ...
  modifiedGmt?: Maybe<ScalarsEnums['String']>;
  /**
   * Connection between the drink type and the drink type
   */
  preview?: Maybe<DrinkToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums['Int']>;
   ...
   */
  slug?: Maybe<ScalarsEnums['String']>;
  smallPrice?: Maybe<ScalarsEnums['String']>;
  /**
   * The current status of the object
   */
  status?: Maybe<ScalarsEnums['String']>;
 ...
 * Connection between the drink type and the drink type
 */
export interface DrinkToPreviewConnectionEdge {
  __typename: 'DrinkToPreviewConnectionEdge' | undefined;
  /**
   * The nodes of the connection, without the edges
   */
  node?: Maybe<Drink>;
...
/**
 * Connection between the RootQuery type and the drink type
 */
export interface RootQueryToDrinkConnection {
  __typename: 'RootQueryToDrinkConnection' | undefined;
  /**
   * Edges for the RootQueryToDrinkConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToDrinkConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Drink>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToDrinkConnectionEdge {
  __typename: 'RootQueryToDrinkConnectionEdge' | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums['String']>;
...
export interface Meal
  extends Omit<Node, '__typename'>,
    ...
    Omit<DatabaseIdentifier, '__typename'>,
    Omit<NodeWithTemplate, '__typename'> {
  __typename: 'Meal' | undefined;
  calories?: Maybe<ScalarsEnums['Float']>;
  comboCost?: Maybe<ScalarsEnums['String']>;
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the ContentNode type and the ContentType type
   */
  ...
  guid?: Maybe<ScalarsEnums['String']>;
  /**
   * The globally unique identifier of the meal object.
   */
  id: ScalarsEnums['ID'];
  /**
   * Whether the object is a node in the preview state
  ...
  modifiedGmt?: Maybe<ScalarsEnums['String']>;
  /**
   * Connection between the meal type and the meal type
   */
  preview?: Maybe<MealToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums['Int']>;
 ...
 * Connection between the meal type and the meal type
 */
export interface MealToPreviewConnectionEdge {
  __typename: 'MealToPreviewConnectionEdge' | undefined;
  /**
   * The nodes of the connection, without the edges
   */
  node?: Maybe<Meal>;
...
/**
 * Connection between the RootQuery type and the meal type
 */
export interface RootQueryToMealConnection {
  __typename: 'RootQueryToMealConnection' | undefined;
  /**
   * Edges for the RootQueryToMealConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToMealConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Meal>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToMealConnectionEdge {
  __typename: 'RootQueryToMealConnectionEdge' | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums['String']>;
...
export interface Side
  ...
  guid?: Maybe<ScalarsEnums['String']>;
  /**
   * The globally unique identifier of the side object.
   */
  id: ScalarsEnums['ID'];
  /**
   * Whether the object is a node in the preview state
  ...
  modifiedGmt?: Maybe<ScalarsEnums['String']>;
  /**
   * Connection between the side type and the side type
   */
  preview?: Maybe<SideToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums['Int']>;
 ...
 * Connection between the side type and the side type
 */
export interface SideToPreviewConnectionEdge {
  __typename: 'SideToPreviewConnectionEdge' | undefined;
  /**
   * The nodes of the connection, without the edges
   */
  node?: Maybe<Side>;
...
/**
 * Connection between the RootQuery type and the side type
 */
export interface RootQueryToSideConnection {
  __typename: 'RootQueryToSideConnection' | undefined;
  /**
   * Edges for the RootQueryToSideConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToSideConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Side>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToSideConnectionEdge {
  __typename: 'RootQueryToSideConnectionEdge' | undefined;
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the createDrink mutation
 */
export interface CreateDrinkPayload {
  __typename: 'CreateDrinkPayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the createMeal mutation
 */
export interface CreateMealPayload {
  __typename: 'CreateMealPayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the createSide mutation
 */
export interface CreateSidePayload {
  __typename: 'CreateSidePayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the deleteDrink mutation
 */
export interface DeleteDrinkPayload {
  __typename: 'DeleteDrinkPayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the deleteMeal mutation
 */
export interface DeleteMealPayload {
  __typename: 'DeleteMealPayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the deleteSide mutation
 */
export interface DeleteSidePayload {
  __typename: 'DeleteSidePayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the updateDrink mutation
 */
export interface UpdateDrinkPayload {
  __typename: 'UpdateDrinkPayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the updateMeal mutation
 */
export interface UpdateMealPayload {
  __typename: 'UpdateMealPayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
/**
 * The payload for the updateSide mutation
 */
export interface UpdateSidePayload {
  __typename: 'UpdateSidePayload' | undefined;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
...
export interface SchemaObjectTypes {
  ...
  Drink: Drink;
  DrinkToPreviewConnectionEdge: DrinkToPreviewConnectionEdge;
  RootQueryToDrinkConnection: RootQueryToDrinkConnection;
  RootQueryToDrinkConnectionEdge: RootQueryToDrinkConnectionEdge;
  GeneralSettings: GeneralSettings;
  Meal: Meal;
  MealToPreviewConnectionEdge: MealToPreviewConnectionEdge;
  RootQueryToMealConnection: RootQueryToMealConnection;
  RootQueryToMealConnectionEdge: RootQueryToMealConnectionEdge;
  ...
  Side: Side;
  SideToPreviewConnectionEdge: SideToPreviewConnectionEdge;
  RootQueryToSideConnection: RootQueryToSideConnection;
  RootQueryToSideConnectionEdge: RootQueryToSideConnectionEdge;
  ...
  CreateDrinkPayload: CreateDrinkPayload;
  ...
  CreateSidePayload: CreateSidePayload;
  ...
  DeleteDrinkPayload: DeleteDrinkPayload;
  DeleteMealPayload: DeleteMealPayload;
  ...
  DeleteSidePayload: DeleteSidePayload;
  ...
  UpdateDrinkPayload: UpdateDrinkPayload;
  UpdateMealPayload: UpdateMealPayload;
  ...
  UpdateSidePayload: UpdateSidePayload;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  DrinkIdType: DrinkIdType | undefined;
  MealIdType: MealIdType | undefined;
  ...
  SideIdType: SideIdType | undefined;
